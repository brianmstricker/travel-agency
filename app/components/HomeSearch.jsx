const HomeSearch = () => {
  return (
    <div className="absolute py-4 bottom-8 mb-[-35px] md:mb-0 md:bottom md:top-20 left-1/2 translate-x-[-50%] bg-white md:w-[650px] w-screen lg:w-[1000px] md:h-[150px] rounded-lg shadow-none md:py-2 md:drop-shadow-2xl md:shadow-2xl">
